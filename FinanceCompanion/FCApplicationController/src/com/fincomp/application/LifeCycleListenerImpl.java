package com.fincomp.application;
  ...
  public void deactivate()
  {
    ...
    private void intializeDBfromScript() throws Exception {
        ...
        try {
            ...
            String dbName = docRoot + "/financeCompanion.db";
            ...
            Utility.ApplicationLogger.info("Reading script financeCompanion.db");
            scriptStream =
