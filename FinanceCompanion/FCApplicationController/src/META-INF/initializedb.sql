...
CREATE TABLE ENTITY (COUNTRY VARCHAR2(100),NAME VARCHAR2(240) PRIMARY KEY, LEDGER VARCHAR2(240), OWNER VARCHAR2(240));
CREATE TABLE FABOOK (BOOKTYPE VARCHAR2(100),NAME VARCHAR2(240) PRIMARY KEY, ENTITY VARCHAR2(240), OWNER VARCHAR2(240));
